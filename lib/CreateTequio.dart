...
class CreateTequioScreen extends StatelessWidget {
  const CreateTequioScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        home: CreateTequioScreenView(),
      ),
    );
  }
}

class CreateTequioScreenView extends StatefulWidget {
  @override
  CreateTequioScreenState createState() => CreateTequioScreenState();
}

class CreateTequioScreenState extends State<CreateTequioScreenView> {
